...
"""
	splitByLines = strGrid.splitlines()
	...
	for idx,strLine in enumerate(grid):
...
for num in test:
	print("The greatest product of " + str(num) + " numbers in the same direction is "
	+ str(greatestProduct(num)))
